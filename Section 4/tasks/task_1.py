...
# So, some computer scientists invented pseudorandom number generators. e.g.
...
print(input('Hello! Let\'s play a game: choose "Heads" or "Tails"\n'))
...
face_random = random.randint(0, 1)
if face_random == 0:
    print(heads)
else:
    print(tails)
